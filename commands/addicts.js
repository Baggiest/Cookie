...
module.exports = {
    ...
    async execute(message) {
        ...
        let i;
        const objects = await User.find({}).limit(15).select('timesPlayed').select('userTag').sort({ timesPlayed: -1 })
        ...
        for (i = 0; i < objects.length; i++) {
            ...
            let score = objects[i].timesPlayed.toString()
        ...
        const leaderEmbed = new MessageEmbed()
            ...
            .setTitle('Lmfao guess game addicts')
            .setColor('YELLOW')
